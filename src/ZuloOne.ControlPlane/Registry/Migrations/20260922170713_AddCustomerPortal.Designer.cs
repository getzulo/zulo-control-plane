...
namespace ZuloOne.ControlPlane.Registry.Migrations
{
    ...
    [Migration("20260922170713_AddCustomerPortal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Portal.CustomerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Portal.CustomerSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Portal.CustomerToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Portal.TenantMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Registry.Tenant", b =>
                {
                    ...
                    b.Property<bool>("StoppedByCustomer")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Portal.CustomerSession", b =>
                {
                    b.HasOne("ZuloOne.ControlPlane.Portal.CustomerAccount", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("ZuloOne.ControlPlane.Portal.TenantMembership", b =>
                {
                    ...
                    b.HasOne("ZuloOne.ControlPlane.Registry.Tenant", "Tenant")
                        .WithMany()
